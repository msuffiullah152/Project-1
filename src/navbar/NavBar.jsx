...
function NavBar() {
  ...
  return (
    <div>
  <p className="screen">Current Conversion Rates</p>
     ...
     <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
      <div class="overflow-hidden">
        <table class="min-w-full text-center text-sm font-light">
          ...
          <tbody>
            <tr class="border-b dark:border-neutral-500">
              ...
              <td class="whitespace-nowrap  px-6 py-4">{conversionRates.USD?.rate_float.toFixed()} USD</td>
              
            </tr>
            <tr class="border-b dark:border-neutral-500">
              <td class="whitespace-nowrap  px-6 py-4 font-medium">2</td>
              <td class="whitespace-nowrap  px-6 py-4 ">EUR/BTC</td>
              <td class="whitespace-nowrap  px-6 py-4">{conversionRates.EUR?.rate_float.toFixed()} EUR</td>
            </tr>
            <tr class="border-b dark:border-neutral-500">
              <td class="whitespace-nowrap  px-6 py-4 font-medium">3</td>
              <td class="whitespace-nowrap  px-6 py-4">GBP/BTC</td>
              <td class="whitespace-nowrap  px-6 py-4">{conversionRates.GBP?.rate_float.toFixed()} GBP</td>
            </tr>
            <tr class="border-b dark:border-neutral-500">
              <td class="whitespace-nowrap  px-6 py-4 font-medium">4</td>
              <td class="whitespace-nowrap  px-6 py-4">BTC/USD</td>
              <td class="whitespace-nowrap  px-6 py-4">{1 / conversionRates.USD?.rate_float} BTC</td>
            </tr>
            <tr class="border-b dark:border-neutral-500">
              <td class="whitespace-nowrap  px-6 py-4 font-medium">5</td>
              <td class="whitespace-nowrap  px-6 py-4">BTC/EUR</td>
              <td class="whitespace-nowrap  px-6 py-4">{1 / conversionRates.EUR?.rate_float} BTC</td>
            </tr>
            <tr class="border-b dark:border-neutral-500">
              <td class="whitespace-nowrap  px-6 py-4 font-medium">6</td>
              <td class="whitespace-nowrap  px-6 py-4">BTC/GBP</td>
              <td class="whitespace-nowrap  px-6 py-4">{1/conversionRates.GBP?.rate_float} BTC</td>
            </tr>
          </tbody> 
        </table>
        ...
        <select value={currency} onChange={handleUpdatedCurrency}>
            ...
            <input type="number" min="0" step="any" value={amount} onChange={handleUpdatedAmount} />
            = {1/conversionRates[currency]?.rate_float*amount} BTC
        <p class="text-sm ...">Last Updated on {lastestRefreshTime} </p>
        <button className="refetch" onClick={handleRefetch}>Refetch</button>
        <br></br>
